// /home/krylon/go/src/github.com/blicero/moodring/database/00_database_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 23. 03. 2021 by Benjamin Walkenhorst
// (c) 2021 Benjamin Walkenhorst
// Time-stamp: <2022-03-22 16:02:36 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/recovery_db_test_20060102_150405")
	)
